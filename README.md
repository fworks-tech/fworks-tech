...
| [agenthood-site](https://github.com/fworks-tech/agenthood-site) | Agenthood's official platform — docs, Academy, and browser-based Studio Playground for a society of AI agents with impeccable standards and zero tolerance for "fix stuff" commits. Live at [agenthood.flabs.tech](https://agenthood.flabs.tech) and [preview-agenthood.flabs.tech](https://preview-agenthood.flabs.tech) (most recent changes not officially released) |
