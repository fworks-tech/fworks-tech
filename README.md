...
| [agenthood](https://github.com/fworks-tech/agenthood) | Society of 20 AI agents as Markdown skill files — SKILL.md open standard, TypeScript runtime, npm package, VS Code extension, Academy, live at [agenthood.flabs.tech](https://agenthood.flabs.tech) |
...
| [hasheyes](https://github.com/fworks-tech/hasheyes) | (under review) Crypto intelligence dashboard — Streamlit, market KPIs, trend charts, risk panels, alerts, news aggregation, newsletter flows, live at [chain-telescope.streamlit.app](https://chain-telescope.streamlit.app) |
...
- 🚀 [**atlaslink**](https://github.com/fworks-tech/atlaslink) — pushed to `vercel-and-flyio` · 3h ago
  **Brief:** A single commit on `vercel-and-flyio` carries the message `fix(deploy): make the Docker image boot the daemon`.
  It changes the Docker image's startup behavior so the daemon is booted as part of the image.
  The branch `vercel-and-flyio` is the concrete artifact to inspect for this deploy fix.
  **Changes:** [`e4c9516`](https://github.com/fworks-tech/atlaslink/commit/e4c951601115a9574a89ebafc82b8e782d913289) fix(deploy): make the Docker image boot
<!-- recent-activity:end -->
